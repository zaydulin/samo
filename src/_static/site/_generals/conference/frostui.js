(function(b, S) {
    typeof exports == "object" && typeof module < "u" ? S(exports) : typeof define == "function" && define.amd ? define(["exports"], S) : (b = typeof globalThis < "u" ? globalThis : b || self,
    S(b.frostui = {}))
}
)(this, function(b) {
    "use strict";
    ...
    var o = (b, S, P) => (Ae(b, typeof S != "symbol" ? S + "" : S, P),
    P);
    const S = new Map
      , P = {
        set(e, i, t) {
    ...
    class I {
        constructor(i, t) {
            ...
            o(this, "_destroyed", !1);
            o(this, "_config", {});
            typeof i == "string" ? this._element = p.findOrById(i) : this._element = i,
            this._config = t ?? {},
            this._element != null && P.set(this.constructor.type, this._element, this)
        }
        get config() {
            return this._config ?? {}
        }
        ...
        destroy() {
            this._destroyed = !0,
            this._element != null && P.remove(this.constructor.type, this._element)
        }
    }
    o(I, "type", "");
    const Lt = {
      ...
      , F = class extends I {
        ...
        init() {
            this._element != null && (this._element.classList.add(F.DEFAULT.class.base),
            this._targetElement = this.getTargetElement()),
            this.initOptions(),
            this.initListener()
        }
        initOptions() {
            this._targetElement != null && !this._targetElement.classList.contains(F.DEFAULT.class.hidden) && this._element.classList.add(F.DEFAULT.class.open),
        ...
        show() {
            this._destroyed || (this.dispatchEvent(F.EVENTS.show),
            this._targetElement != null && this._element != null && (this._element.classList.add(F.DEFAULT.class.open),
            this._targetElement.classList.remove(F.DEFAULT.class.hidden),
        ...
        hide() {
            this._destroyed || (this.dispatchEvent(F.EVENTS.hide),
            this._targetElement != null && this._element != null && (this._element.classList.remove(F.DEFAULT.class.open),
            this._targetElement.style.height = `${this._targetElement.scrollHeight}px`,
            Lt.afterTransition(this._targetElement, () => {
                this.isShown || (this._targetElement.classList.add(F.DEFAULT.class.hidden),
    ...
    const ae = async (e, i, t) => {
        const {placement: n="bottom", strategy: s="absolute", middleware: a=[], platform: l} = t
          , r = a.filter(Boolean)
        ...
        for (let u = 0; u < r.length; u++) {
            const {name: L, fn: v} = r[u]
              , {x: y, y: _, data: R, reset: U} = await v({
                x: f,
                y: c,
                initialPlacement: n,
                placement: m,
            ...
            U && E <= 50 && (E++,
            typeof U == "object" && (U.placement && (m = U.placement),
            U.rects && (h = U.rects === !0 ? await l.getElementRects({
                reference: e,
                floating: i,
                strategy: s
            }) : U.rects),
    ...
    async function Mt(e, i) {
        var t;
        i === void 0 && (i = {});
        const {x: n, y: s, platform: a, rects: l, elements: r, strategy: d} = e
          , {boundary: h="clippingAncestors", rootBoundary: f="viewport", elementContext: c="floating", altBoundary: m=!1, padding: g=0} = i
          , E = Ht(g)
          , u = r[m ? c === "floating" ? "reference" : "floating" : c]
          , L = yt(await a.getClippingRect({
          ...
          , _ = await (a.isElement == null ? void 0 : a.isElement(y)) && await (a.getScale == null ? void 0 : a.getScale(y)) || {
            x: 1,
            y: 1
        }
    ...
    const ce = e => ({
        ...
        async fn(i) {
            const {element: t, padding: n=0} = e || {}
              , {x: s, y: a, placement: l, rects: r, platform: d, elements: h} = i;
            if (t == null)
                return {};
            const f = Ht(n)
              , c = {
    ...
    const me = function(e) {
        return e === void 0 && (e = {}),
        {
            ...
            async fn(i) {
                var t;
                const {placement: n, middlewareData: s, rects: a, initialPlacement: l, platform: r, elements: d} = i
                  , {mainAxis: h=!0, crossAxis: f=!0, fallbackPlacements: c, fallbackStrategy: m="bestFit", fallbackAxisSideDirection: g="none", flipAlignment: E=!0, ...u} = e
                  , L = et(n)
                  , v = et(l) === l
                  , y = await (r.isRTL == null ? void 0 : r.isRTL(d.floating))
                  , _ = c || (v || !E ? [wt(l)] : function(k) {
                    const $ = wt(k);
                    return [Ot(k), $, Ot($)]
                }(l));
                ...
                !J.every(k => k <= 0)) {
                    ...
                    if (!rt)
                        ...
                        case "bestFit":
                            {
                                var M;
                                const tt = (M = lt.map(K => [K.placement, K.overflows.filter(N => N > 0).reduce( (N, pt) => N + pt, 0)]).sort( (K, N) => K[1] - N[1])[0]) == null ? void 0 : M[0];
                                tt && (rt = tt);
                                break
                            }
                ...
                const {x: t, y: n} = i
                  , s = await async function(a, l) {
                    const {placement: r, platform: d, elements: h} = a
                      , f = await (d.isRTL == null ? void 0 : d.isRTL(h.floating))
                      , c = et(r)
                      , m = dt(r)
                      , g = ft(r) === "x"
                    ...
                    let {mainAxis: v, crossAxis: y, alignmentAxis: _} = typeof L == "number" ? {
                        mainAxis: L,
                        crossAxis: 0,
                        alignmentAxis: null
                    } : {
                    ...
                    return m && typeof _ == "number" && (y = m === "end" ? -1 * _ : _),
                    g ? {
                        x: y * u,
                        y: v * E
                    } : {
    ...
    function Wt() {
        ...
        return e && Array.isArray(e.brands) ? (vt = e.brands.map(i => i.brand + "/" + i.version).join(" "),
    ...
    function Qt(e, i, t) {
        ...
        if (i === "viewport")
            ...
            if (Rt()) {
                var s, a;
                const r = C(e);
                l.x -= ((s = r.visualViewport) == null ? void 0 : s.offsetLeft) || 0,
                l.y -= ((a = r.visualViewport) == null ? void 0 : a.offsetTop) || 0
            }
            n = l
        }
        return yt(n)
    ...
    function te(e, i) {
        ...
        if (!V(e))
            return t;
        let n = Zt(e, i);
        for (; n && Ee(n) && H(n).position === "static"; )
            n = Zt(n, i);
    ...
    function pe(e, i, t) {
        ...
        if (n || !n && t !== "fixed")
            if ((Y(i) !== "body" || Tt(s)) && (l = _t(i)),
            V(i)) {
                const d = gt(i, !0);
                r.x = d.x + i.clientLeft,
                r.y = d.y + i.clientTop
            } else
                s && (r.x = Xt(s));
        return {
    ...
    const Le = {
        getClippingRect: function(e) {
            ...
            const a = t === "clippingAncestors" ? function(h, f) {
                ...
                for (; G(u) && !Nt(u); ) {
                    ...
                    (E ? v || g : v || L.position !== "static" || !g || !["absolute", "fixed"].includes(g.position)) ? g = L : m = m.filter(y => y !== u),
                    u = ut(u)
                }
                return f.set(h, m),
                m
        ...
        convertOffsetParentRelativeRectToViewportRelativeRect: function(e) {
            ...
            if ((s || !s && n !== "fixed") && ((Y(t) !== "body" || Tt(a)) && (l = _t(t)),
            V(t))) {
                const h = gt(t);
                r = ct(t),
      ...
      , T = class extends I {
        ...
        show() {
            ...
            this._targetElement != null && this._element != null && (this._targetElement.classList.remove(T.DEFAULT.class.hidden),
            setTimeout( () => {
                this._element.classList.add(T.DEFAULT.class.open),
                this._targetElement.classList.add(T.DEFAULT.class.open)
            }
            , 1)),
        ...
        hide() {
            ...
            this.clicked = !1,
            this._targetElement != null && ((t = this._element) == null || t.classList.remove(T.DEFAULT.class.open),
        ...
        init() {
            this._element != null && (this._targetElement = this.getTargetElement(),
            this.initOptions(),
            this.initListener())
        }
        initOptions() {
            var t, n, s, a;
            if ((t = this._element) == null || t.classList.add(T.DEFAULT.class.base),
            (n = this._targetElement) == null || n.classList.add(T.DEFAULT.class.base),
            this._placement = p.getAttribute(this._element, T.DEFAULT.attr.placement, this.config.placement),
            this._trigger = p.getAttribute(this._element, T.DEFAULT.attr.trigger, this.config.trigger ?? "click"),
            this._autoclose = p.getAttribute(this._element, T.DEFAULT.attr.autoclose, this.config.autoclose ?? "both"),
            ((s = this._targetElement) == null ? void 0 : s.classList.contains(T.DEFAULT.class.hidden)) === !1 && this.show(),
            (a = this._element) != null && a.hasAttribute(T.DEFAULT.attr.offset)) {
        ...
        initListener() {
            ...
            (t = this._element) == null || t.addEventListener("click", () => {
                this._destroyed || (this.isHover ? (this.clicked ? this.hide() : this.show(),
                this.clicked = !this.clicked) : this.toggle())
            }
            ),
            ...
            window.addEventListener("click", s => {
                if (!this._destroyed && this._targetElement != null && this._element != null && s.target instanceof HTMLElement) {
                    if (p.isElementSameOrContains(this._element, s.target))
                        return;
    ...
    const A = class extends I {
        ...
        show() {
            if (this.dispatchEvent(A.EVENTS.show),
            this._targetElement != null && this._element != null) {
                const t = document.documentElement.clientWidth;
                document.body.style.paddingRight = Math.abs(window.innerWidth - t) + "px",
                document.body.classList.add(A.DEFAULT.class.overflowHidden),
                this._element.classList.add(A.DEFAULT.class.open),
                this._targetElement.classList.remove(A.DEFAULT.class.hidden),
                setTimeout( () => {
                    this._targetElement.classList.add(A.DEFAULT.class.open),
                    p.showOverlay(),
                    this._windowClickListen || (window.addEventListener("click", this.onWindowClicked),
        ...
        hide() {
            ...
            this._targetElement != null && this.isShown && (document.body.classList.remove(A.DEFAULT.class.overflowHidden),
            (t = this._element) == null || t.classList.remove(A.DEFAULT.class.open),
            ...
            setTimeout( () => {
                ...
                p.hideOverlay(),
                this._targetElement.classList.add(A.DEFAULT.class.hidden)
            }
            , 1)),
            window.removeEventListener("keydown", this.keyListener),
    ...
    const w = class extends I {
        ...
        show() {
            ...
            this._targetElement != null && this._element != null && (this._targetElement.classList.remove(w.DEFAULT.class.hidden),
            this._targetElement.classList.remove(w.DEFAULT.class.opacity0),
            setTimeout( () => {
                this._element.classList.add(w.DEFAULT.class.open),
                this._targetElement.classList.add(w.DEFAULT.class.open),
                this._targetElement.classList.add(w.DEFAULT.class.opacity100)
            }
            , 1)),
        ...
        hide() {
            ...
            this._targetElement != null && ((t = this._element) == null || t.classList.remove(w.DEFAULT.class.open),
            this._targetElement.classList.add(w.DEFAULT.class.opacity0),
            this._targetElement.classList.remove(w.DEFAULT.class.opacity100),
        ...
        init() {
            ...
            t ? this._targetElement = p.findOrById(t) : this._targetElement = p.nextElementSibling(this._element),
            this._targetElement && (this._arrowElement = this._targetElement.querySelector(`[${w.DEFAULT.attr.arrow}]`)),
            this.initOptions(),
            this.initListener()
        }
        initOptions() {
            var t, n, s, a, l;
            if ((t = this._element) != null && t.hasAttribute(w.DEFAULT.attr.placement) && (this.config.placement = (n = this._element) == null ? void 0 : n.getAttribute(w.DEFAULT.attr.placement)),
            (s = this._element) != null && s.hasAttribute(w.DEFAULT.attr.trigger) && (this.config.trigger = ((a = this._element) == null ? void 0 : a.getAttribute(w.DEFAULT.attr.trigger)) === "click" ? "click" : "hover"),
            (l = this._element) != null && l.hasAttribute(w.DEFAULT.attr.offset)) {
        ...
        computeTooltipPosition() {
            ...
            this._element != null && this._targetElement != null && (this._targetElement.classList.add(w.DEFAULT.class.absolute),
            this._arrowElement && this._arrowElement.classList.add(w.DEFAULT.class.absolute),
            ee(this._element, this._targetElement, {
                ...
                a.arrow && this._arrowElement) {
                    const {x: f, y: c} = a.arrow
                      , m = f != null ? `${f}px` : `${-this._arrowElement.offsetWidth / 2}px`
                      , g = c != null ? `${c}px` : `${-this._arrowElement.offsetHeight / 2}px`
                      , E = {
    ...
    const x = class extends I {
        ...
        init() {
            var t;
            this._element != null && (this._targetElement = this.getTargetElement(),
            (t = this._targetElement) == null || t.classList.add(x.DEFAULT.class.base),
            this.initOptions(),
            this.initListener())
        }
        initOptions() {
        ...
        show() {
            if (this.dispatchEvent(x.EVENTS.show),
            this._targetElement != null && this._element != null && (this._targetElement.classList.remove(x.DEFAULT.class.hidden),
        ...
        hide() {
            var t;
            this.isShown && (this.dispatchEvent(x.EVENTS.hide),
            this._targetElement != null && this.isShown && ((t = this._element) == null || t.classList.remove(x.DEFAULT.class.open),
            this._targetElement.classList.remove(x.DEFAULT.class.open),
            Lt.afterTransition(this._targetElement, () => {
                this._targetElement.classList.add(x.DEFAULT.class.hidden),
                this.config.backdrop && p.hideOverlay()
            }
            ),
            this.config.scroll || (document.body.classList.remove("overflow-hidden"),
            Object.assign(document.body.style, {
                paddingRight: null
            }))),
            window.removeEventListener("keydown", this.keyListener),
    ...
    const ht = class extends I {
        ...
        init() {
            this._element != null && (this._targetElement = this._getTargetElement()),
        ...
        hide() {
            ...
            this._targetElement != null && this._targetElement.classList.add(ht.DEFAULT.class.hidden),
    ...
    const ye = {
      ...
      , St = class {
        static get state() {
            return this._initialize || (this._initialize = this.retrieveFromLocal()),
            this._state
        }
        static init() {
        ...
        static retrieveFromLocal() {
            ...
            return Object.keys(t).forEach(n => t[n] == null ? t[n] = this.defaultState[n] : void 0),
            this._state = t,
            !0
        }
    ...
    class it {
        ...
        static themeChangeListener(i) {
            i.theme == "system" ? (it.changeTheme(window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"),
            window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", it.windowThemeListener)) : (it.changeTheme(i.theme),
            window.matchMedia("(prefers-color-scheme: dark)").removeEventListener("change", it.windowThemeListener))
        }
    ...
    const st = class extends I {
        ...
        notifyThemeChanged(t) {
            ...
            if (this.trigger != "switch")
                (n = this._element) == null || n.classList.remove("light-theme", "dark-theme", "system-theme"),
                (s = this._element) == null || s.classList.add(`${t}-theme`);
            else if (this._element instanceof HTMLInputElement) {
                const a = this._element;
                t != "dark" ? (a.removeAttribute("checked"),
                a.checked = !1) : (a.setAttribute("checked", "checked"),
                a.checked = !0)
            }
        }
        init() {
            this._element != null && (this._element.classList.add(st.DEFAULT.class.base),
            this.theme = p.getAttribute(this._element, st.DEFAULT.attr.theme, this.config.theme),
            this.trigger = p.getAttribute(this._element, st.DEFAULT.attr.trigger, this.config.trigger),
            this.initListeners(),
    ...
    const kt = class {
        static get instance() {
            return this._instance == null && (this._instance = new kt),
            this._instance
        }
        init() {
            typeof window < "u" && (D.init(),
            it.init(),
            p.addOverlay(["transition-all", "fixed", "inset-0", "z-40", "bg-gray-900", "bg-opacity-50", "dark:bg-opacity-80"]),
    ...
    const ie = At.instance
      ...
      , ne = ie.init;
    typeof window < "u" && (window.frost = we,
    ne()),
    b.Accordion = X,
    b.Collapse = O,
    b.Dismissable = z,
