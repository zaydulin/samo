    ...
    init: function () {
      Morris.Area({
        ...
        Morris.Bar({
          ...
          xkey: "x",
          ykeys: ["y", "z", "a"],
          barColors: [CubaAdminConfig.primary, CubaAdminConfig.secondary, "#65c15c"],
          labels: ["Y", "Z", "A"],
        }),
        Morris.Bar({
        ...
        $(function () {
          Morris.Donut({
            ...
            labelColor: "#999999",
            colors: [CubaAdminConfig.primary, CubaAdminConfig.secondary, "#ffb829", "#65c15c", "rgba(248, 214, 43, 1)", "#65c15c", "#ffb829"],
        ...
        $(function () {
          Morris.Bar({
            ...
            ykeys: ["y", "z", "a"],
            labels: ["A", "Y", "Z"],
            barColors: [CubaAdminConfig.primary, CubaAdminConfig.secondary, "#65c15c", "#ffb829", "#a927f9", CubaAdminConfig.secondary, CubaAdminConfig.primary],
            stacked: !0,
          });
        });
    },
